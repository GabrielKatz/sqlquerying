...
SQL verf"ugt "uber sehr viele Funktionen, um mit den internen Datentypen zu transformieren. Beispielsweise gibt es eine
...
K"onnte in der Spalte $AlbumFk$ der Tabelle $Track$ leer sein? Wieso bzw. wieso nicht?
\end{exercise}
\begin{table}
    \begin{tabular}{|llll|}
    \hline
...
automatisch generiert werden soll, variiert von System zu System. Daher gehen wir hier nicht n"aher darauf ein.
...
referenzierende Datensätze auch gleich l"oschen. Die Datenbank kann so eingestellt sein, dass sie dies gleich automatisch tut. Diese Einstellung
...
FROM Service
WHERE Deleted = 0
\end{lstlisting} section{Updates}
...
UPDATE Service
SET Name = 'Nur Waschen', DurationMinutes = DurationMinutes - 5
WHERE ServiceId = 1
\end{lstlisting} 
...
Die Äussere Abfrage sammelt weitere Informationen zur Bestellung.
