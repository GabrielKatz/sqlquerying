...
\textbf{\lstinline{CHAR(l)}} ist eine Zeichenkette mit fixer L"ange $l$.\\
\textbf{\lstinline{VARCHAR(l)}} ist eine Zeichenkette mit H"ochstl"ange $l$.\\
...
\begin{example}
Zeige die Anzahl der Buchungen f"ur jeden Service, welcher gebucht wurde, an. Zeige für jeden Service den Namen an
...
\item Wir wissen, wie man das \lstinline{GROUP BY} "uber eine Tabelle einsetzt, und wie man die Probleme vermeiden kann, welche dabei
auftreten k"onnen.
